...
class Educator {
    static async createEducatorProfile  (req, res, next)  {
        ...
        try {
            ...
            const q = 'UPDATE educator SET bio = ?, profile_picture_url = ?, time_zone = ?, subjects = ?, grades = ?, classes = ?, location = ?, experience_years = ?, education = ?, certifications = ?, availability = ? WHERE id = 1';
